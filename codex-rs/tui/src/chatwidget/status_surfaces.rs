...
use crate::status::format_tokens_in_thousands;
...
impl ChatWidget {
    ...
    pub(super) fn status_line_value(&mut self, item: StatusLineItem) -> Option<String> {
        match item {
            ...
            StatusLineItem::ContextWindowSize => self
                ...
                .map(|cws| format!("{} window", format_tokens_in_thousands(cws))),
    ...
    pub(super) fn run_state_status_text(&self) -> String {
        ...
        match self.status_state.terminal_title_status_kind {
            ...
            TerminalTitleStatusKind::WaitingForTerminal if !self.bottom_pane.is_task_running() => {
                "Ready".to_string()
            }
            ...
            TerminalTitleStatusKind::WaitingForTerminal => "Waiting".to_string(),

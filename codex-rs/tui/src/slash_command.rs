    ...
    pub fn description(self) -> &'static str {
        match self {
            ...
            SlashCommand::Compact => {
                "summarize conversation; optionally choose local, remotev1, or remotev2"
            }
            ...
            SlashCommand::Diff => "toggle the diff panel (including untracked files)",
            ...
            SlashCommand::Ps => "list running terminals",
            SlashCommand::Stop => "stop all running terminals",
            SlashCommand::MemoryDrop => "DO NOT USE",
            SlashCommand::MemoryUpdate => "DO NOT USE",
            SlashCommand::Model => "choose what model and reasoning effort to use",
            SlashCommand::Provider => "choose a configured model provider for this session",
            SlashCommand::Ide => {
